// CLOUDFLARE WORKER - Proxy API Anthropic + OpenAI Image
// Briefline - Instagram Content Generator (white-label)
...
const SYSTEM_PROMPT = [
  ...
  "- NUNCA use nomes reais de pessoas publicas, empresas ou marcas registradas no prompt de imagem",
  "- Substitua sempre por descricoes fisicas, contextuais e de cores",
  "- Exemplos de substituicao por categoria:",
  '  - Pessoa publica: "[nome do atleta]" -> "athletic male in his 30s, focused expression, sportswear"',
  '  - Marca de carro: "[marca esportiva premium]" -> "sleek luxury sports car in deep silver with chrome accents"',
  '  - Marca de moda: "[grife italiana]" -> "minimalist tailored suit in charcoal wool, refined craftsmanship"',
  '  - Logo/produto: descreva forma, cor e contexto sem citar a marca',
  "- Se o nicho mencionar marcas especificas, capture a essencia visual sem citar nomes",
  "",
  "### Tom Visual - Paletas disponiveis",
  "- Dark/Cinematografico: fundo escuro, iluminacao dramatica lateral, sombras profundas, destaques contrastantes",
  "- Bright/Editorial: fundo claro, luz difusa suave, cores saturadas mas limpas, tipografia bold",
  ...
  "- SEMPRE especifique perspectiva (POV interno / externo / aereo / close-up / wide shot etc.)",
  "- SEMPRE especifique lente simulada (ex: simulated 85mm lens, shallow depth of field)",
  "- Watermark: use o @ informado no campo Marca dagua do briefing. Se nao informado, mas houver DNA do perfil com @ identificavel, use esse @. Se nenhum disponivel, omita a instrucao de watermark. NUNCA invente um @ padrao.",
  ...
  "- Exatamente 3 hashtags estrategicos relacionados ao nicho informado",
  ...
  "",
  "### Tema",
  "- Escolha o tema com maior potencial de engajamento para o publico-alvo dentro do nicho informado",
